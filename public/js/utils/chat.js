...
const UIController = ()=>{
    ...
    const DOMStrings = {
        ...
        messageInput :document.querySelector('#message-form').querySelector('input'),
        messageButton :document.querySelector('#message-form').querySelector('#send-message'),
        locationButton :document.querySelector('#message-form').querySelector('#send-location')
   }
   ...
   console.log("Required successfully UI")
return {
    DOMStrings,
    Templates,
    getMsgInput,
...
UICtrl.DOMStrings.messageForm.addEventListener('submit', (e) => {
    e.preventDefault()
    ModelCtrl.sendMsg(UICtrl.getMsgInput(), UICtrl.Templates.messageSentTemplate)
}) 
...
console.log("Required successfully Model")
